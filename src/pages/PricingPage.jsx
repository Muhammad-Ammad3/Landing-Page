    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="pt-24 pb-16 px-6 text-center">
        ...
        <div className="flex items-center justify-center space-x-4">
          <span
            className={
              billingCycle === "monthly" ? "font-bold" : "text-slate-500"
            }
          >
            Monthly
          </span>
          ...
          <span
            className={
              billingCycle === "yearly" ? "font-bold" : "text-slate-500"
            }
          >
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8 pb-20">
        {pricingPlans.map((plan, index) => (
          <div
            key={index}
            className={`bg-white p-8 rounded-3xl shadow-xl border-2 ${plan.popular ? "border-indigo-500 scale-105" : "border-transparent"}`}
          >
            <div
              className={`w-12 h-12 ${plan.color} rounded-xl flex items-center justify-center text-white mb-6`}
            >
              <plan.icon size={24} />
            </div>
            ...
            <button className="w-full py-3 bg-slate-900 text-white rounded-xl font-bold hover:bg-indigo-600 transition">
              Get Started
            </button>
          </div>
        ))}
